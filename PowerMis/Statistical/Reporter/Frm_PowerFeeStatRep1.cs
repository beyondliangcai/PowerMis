...
{
    public partial class Frm_PowerFeeStatRep1 : Form
    {
        string month = "";
        public Frm_PowerFeeStatRep1(string month)
        {
            InitializeComponent();
            this.month = month;
        ...
        private void Frm_PowerFeeStatRep1_Load(object sender, EventArgs e)
        {
